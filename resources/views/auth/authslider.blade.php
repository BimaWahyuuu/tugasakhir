    ...
    <div id="myCarousel" class="carousel slide carousel-fade" data-ride="carousel">
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                <img class="img-responsive center-block" src="{{ asset('masuk/img/step1.png') }}" alt="step1">
            ...
            <div class="item">
                <img class="img-responsive center-block" src="{{ asset('masuk/img/step2.png') }}" alt="step2">
                <div class="item-content">
            ...
            <div class="item">
                <img class="img-responsive center-block" src="{{ asset('masuk/img/step3.png') }}" alt="step3">
                <div class="item-content">
