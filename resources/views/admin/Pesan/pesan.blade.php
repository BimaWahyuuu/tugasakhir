...
@section('title', $saran->bidang->bidang)
@section('content')
    ...
    <div class="col-md-6">
      <article class="article article-style-c"> 
        <div class="article-details">
          ...
          <div class="card-body">
            <div class="gallery">
                <div class="gallery-item" data-image="{{ asset('img/wahyudi.jpg') }}" data-title="Klik Untuk Tampilan Penuh" href="../assets/img/news/img01.jpg" title="Image 1" style="background-image: url({{ asset('stisla/assets/img/news/img01.jpg') }});"></div>
            </div>
          </div>
          <p>{{$saran->deskripsi}}</p>
    ...
    <div class="col-md-6">
      <article class="article article-style-c">
        <div class="article-header">
          <img src="{{ asset('img/wahyudi.jpg') }}" alt="" style="background-size: cover" class="img-fluid">
        </div>
      </article>
    </div>
  </div>
